...
export const OAUTH_CONFIGS: Record<string, OAuthConfig> = {
  ...
  instagram: {
    clientId: process.env.INSTAGRAM_CLIENT_ID || process.env.FACEBOOK_CLIENT_ID || "YOUR_INSTAGRAM_CLIENT_ID",
    clientSecret: process.env.INSTAGRAM_CLIENT_SECRET || process.env.FACEBOOK_CLIENT_SECRET || "YOUR_INSTAGRAM_CLIENT_SECRET",
